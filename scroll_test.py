...
class MyApp(tk.Tk):
    ...
    def show_records(self):
        ...
        label1a = tk.Label(top_frame, text="Title", bg=BG, width=20)
        label1a.grid(row=0, column=0, padx=3, pady=5)

        label1b = tk.Label(top_frame, text="Year of production", bg=BG, width=20)
        label1b.grid(row=0, column=1, padx=3, pady=5)

        label1c = tk.Label(top_frame, text="Length", bg=BG, width=20)
        label1c.grid(row=0, column=2, padx=3, pady=5)

        cb_var1a = tk.IntVar()
        checkbutton1a = tk.Checkbutton(top_frame, text="StartCheckBox", variable=cb_var1a, bg=BG)
        checkbutton1a.grid(row=1, column=0, padx=2)

        cb_var1b = tk.IntVar()
        checkbutton1b = tk.Checkbutton(top_frame, text="Startbb", variable=cb_var1b, bg=BG)
        checkbutton1b.grid(row=1, column=1, padx=2)

        cb_var1c = tk.IntVar()
        checkbutton1c = tk.Checkbutton(top_frame, text="Startccc", variable=cb_var1c, bg=BG)
        checkbutton1c.grid(row=1, column=2, padx=2)
        ...
        add_button = tk.Button(bottom_frame, text="Add", bg="#33ff33")
        add_button.grid(row=0, column=0, padx=20)

        update_button = tk.Button(bottom_frame, text="Update", bg="Yellow")
        update_button.grid(row=0, column=1, padx=20)

        delete_button = tk.Button(bottom_frame, text="Delete", bg="Red")
